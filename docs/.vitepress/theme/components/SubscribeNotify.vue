...
function playSuccessAnimation() {
  ...
  for (let i = 0; i < text.length; i++) {
    ...
    span.style.cssText = [
      ...
      'font-weight:900',
      'color:#00E5A0',
      '-webkit-text-stroke:1.5px rgba(0,180,120,0.5)',
      "text-shadow:0 0 10px rgba(0,229,160,1), 0 0 30px rgba(0,200,140,0.8), 0 0 60px rgba(0,180,120,0.6), 0 0 100px rgba(0,150,100,0.3)",
      'pointer-events:none',
      'z-index:9999',
